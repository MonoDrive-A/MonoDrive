...
| `train/__init__.py` | 作为训练辅助包入口，懒加载并导出训练数据处理公开接口。 | [train/__init___abstract.md](train/__init___abstract.md) | [train/__init__.md](train/__init__.md) | 已同步 |
...
| `visualization/backbone_feature_pca_viewer.py` | 直接调用统一主干并以 FP32 导出每层视觉 Token PCA 图，同时在 BEV 面板默认展示完整 48 个 Agent 和 48 个 Map 查询。 | [visualization/backbone_feature_pca_viewer_abstract.md](visualization/backbone_feature_pca_viewer_abstract.md) | [visualization/backbone_feature_pca_viewer.md](visualization/backbone_feature_pca_viewer.md) | 已同步 |
