...
| `model/backbone.py` | 复用已有嵌入与解码模块，构造 16 层两阶段统一序列主干；前 12 层检测 Token 逐层旁路残差与 per-layer 身份嵌入，第 12 层 Acc 接检测头，第 13 层前注入目标点 Token。 | [model/backbone_abstract.md](model/backbone_abstract.md) | [model/backbone.md](model/backbone.md) | 已同步 |
