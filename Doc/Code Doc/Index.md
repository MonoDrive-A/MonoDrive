...
| `visualization/backbone_feature_pca_viewer.py` | 直接调用统一主干并以 FP32 导出每层视觉 Token PCA 图，用于检查 Transformer 主干特征演化。 | [visualization/backbone_feature_pca_viewer_abstract.md](visualization/backbone_feature_pca_viewer_abstract.md) | [visualization/backbone_feature_pca_viewer.md](visualization/backbone_feature_pca_viewer.md) | 已同步 |
